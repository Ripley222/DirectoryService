...
- Возможность soft deleted подразделения
- Получение топ подразделений по позициям
- Получение корневых подразделений с N-количеством дочерних подразделений и пагинацией данных
- Получение дочерних подраздлелений используя ленивую подгрузку и пагинацию данных
...
- Создание, получение, обновление и soft удаление сущностей
